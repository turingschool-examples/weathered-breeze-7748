...
RSpec.describe Experiment, type: :model do
  ...
  describe "class methods" do
    ...
    it "#long_run_experiments" do
      results = Experiment.long_run_experiments
      expect(results).to eq([@experiment6.name, @experiment3.name, @experiment5.name, @experiment2.name])
    end
  end
end
